...
<script
	src="../../../resources/js/plugins/dataTables/dataTables.bootstrap.js"></script>
					...
					<div class="header-search">
						<form action="/product/list" method="get" oninput="x.value=Math.ceil(parseInt(price.value)*${pricetotal == null? 100 : pricetotal}/100000)*1000">
							<input class="input search-input" type="text" name="keyword"
								...
								class="input search-categories" name="type">
				...
				<div class="pull-right">
					<ul class="header-btns">
						...
						<li class="header-cart dropdown default-dropdown"><a
							...
							aria-expanded="true"> <strong class="text-uppercase">My
									Cart:</strong> <br> <span>35.20$</span> <!-- ì¥ë°êµ¬ë ì´ ê°ê²© count -->
						</a>
